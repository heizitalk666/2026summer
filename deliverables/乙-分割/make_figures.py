...
跑这个脚本需要 matplotlib 与 opencv；中文字体取微软雅黑，没有的话退回默认。
"""
...
def reading_error():
    ...
    ax.text(0.5, 0.585, "密度 < 96 px\n系统不下读数结论", ha="center", va="top",
            fontsize=9, color="0.30")
    ax.text(0.5, 0.03, "numpy 基线 30–60 px 的 P90 = 1.44（越界，未画）",
    ...
    ax.text(1.53, 0.56, "读入门槛 %.0f px\n（120 × 0.8）" % READ_FLOOR_PX,
